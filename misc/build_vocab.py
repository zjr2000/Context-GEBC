...
if True:
    file_path_list = ["data/gebc/trainset_highest_f1_after.json",
                        "data/gebc/trainset_highest_f1_before.json",
                        "data/gebc/trainset_highest_f1_subject.json",
                        "data/gebc/valset_highest_f1_after.json",
                        "data/gebc/valset_highest_f1_before.json",
                        "data/gebc/valset_highest_f1_subject.json",]
    mark = [',', ':', '!', '_', ';', '.', '?', '"', '\\n', '\\']
    count_threshold = 0
    output_path = 'data/gebc/vocabulary_gebc_thres0.json'

if False:
    file_path_list = ["data/anet/captiondata/train_modified.json", "data/anet/captiondata/val_1.json", "data/anet/captiondata/val_2.json"]
    ...
    output_path = './data/vocabulary_activitynet_thres2.json'
